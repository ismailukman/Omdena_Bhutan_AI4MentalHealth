...
st.set_page_config(page_title="Mental Health and Well-being Assistant ", page_icon="🧠")
...
st.title("🧠 Mental Health & Well-being Assistant")
...
if not st.session_state.chat_started:
    with st.form(key="user_info_form"):
        ...
        education = st.selectbox("Education level:", ["Non-degree", "BSc", "MSc", "PhD"])
